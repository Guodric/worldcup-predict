...
async function generateMatchPrompt(env) {
  ...
  for (const date of allDates) {
    ...
    const prompt = `你是2026年美加墨世界杯竞猜群的主持人。以下是今天的世界杯小组赛对阵。写一段引导性文案（100字以内），提到具体对阵的看点、球队特点、关键球星等。语气兴奋有煽动性。不要提赔率。不要markdown。
